<?php 
    ...
    //                             echo "<script>alert('This player has already registered');";
    //                             die("window.history.go(-1);</script>"); 
    //                         }
    //                             elseif($rows['pass1'] === $passnum1) {
    //                                 echo "<script>alert('Player 1 IC /Passport number already registered');";
    //                                 die("window.history.go(-1);</script>"); 
    //                             }
    //                                 elseif($rows['phone1'] === $phonenum1) {
    //                                     echo "<script>alert('Player 1 phone number already registered');";
    //                                     die("window.history.go(-1);</script>"); 
    //                                 }
    ...
    //                                             echo "<script>alert('Player 2 IC /Passport number already registered');";
    //                                             die("window.history.go(-1);</script>"); 
    //                                         }
    ...
    //             echo "<script>alert('Player 1 name cannot be the same as player 2');";
    //             die("window.history.go(-1);</script>"); 
    //         }
